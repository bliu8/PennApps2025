...
Optimized for pitch/demo with diverse, realistic food items
"""
...
async def populate_demo_data():
    """Populate database with demo-optimized food data"""
    ...
    print(f"🍳 Total recipes: {len(demo_recipes)}")
    print(f"🔔 Total notifications: {len(demo_notifications)}")
