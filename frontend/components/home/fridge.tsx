...
// import { sampleRecipes, sampleInventoryItems } from '@/constants/mock-data';
...
// // Normalize mock data to match the local InventoryItem type
// function normalizeSampleItems(): InventoryItem[] {
//   const allowed = ['g', 'kg', 'oz', 'lb', 'ml', 'L', 'pieces'] as const;
//   return sampleInventoryItems.map((it: any) => ({
//     ...it,
//     baseUnit: (allowed as readonly string[]).includes(it.baseUnit)
//       ? (it.baseUnit as InventoryItem['baseUnit'])
//       : 'pieces',
//   }));
// }
...
//     // If this press would take us to zero, open confirmation instead of auto-marking used
...
//     try {
//       await onEditQuantity?.(itemId, newQty);
//       refreshInventory();
//       triggerRefresh();
//     } catch (error) {
...
//                   <ThemedText lightColor={Colors.light.success} darkColor={Colors.dark.success} style={[{flex: 1}, styles.modalChoiceText}]>Used it!</ThemedText>
//                 </AnimatedIconButton>
//               </View>
//             </View>
//           </View>
